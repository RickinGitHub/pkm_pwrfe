...
def main() -> None:
    ...
    # Shared corpus loader — single I/O, shared across both knowledge servers
    corpus_loader = CorpusLoader("rag/corpus")
    ...
    agent.register_mcp("hybrid_knowledge", HybridKnowledgeServer(corpus_loader))
